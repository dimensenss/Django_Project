# Generated by Django 4.2.6 on 2024-01-13 16:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='goods.sneakers', verbose_name='Продукт')),
            ],
            options={
