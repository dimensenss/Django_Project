...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sneakers_shop', '0008_sneakers_tags'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='sneakers',
            name='cat',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='sneakers_shop.category', verbose_name='Категорія'),
        ),
        migrations.AlterField(
            model_name='sneakers',
            name='discount',
